...
class StrokeModel(nn.Module):
    def _init_(self):
        ...
        self.resnet.fc = nn.Sequential(
            ...
            nn.Linear(256, 256),
            nn.ReLU(),
            nn.Linear(256, 2)  # İkili sınıflandırma
        )
...
def train_model(model, train_loader, test_loader, criterion, optimizer, epochs=epoch, fold_name="fold"):
    ...
    for epoch in range(epochs):
        ...
        if test_accuracy > best_acc:
            ...
            best_model_wts = copy.deepcopy(model.state_dict())
            torch.save(model.state_dict(), f'/content/drive/MyDrive/Teknofest_Braincoders/resnet_best_model_{fold}.pth')
...
for fold in folds:
    ...
    model.load_state_dict(torch.load(f'/content/drive/MyDrive/Teknofest_Braincoders/resnet_best_model_{fold}.pth'))
