...
base_path=r'/content/drive/MyDrive/Teknofest_Braincoders/Alt_Kumeler_Augmantasyon/Fold1'
test_dataset = StrokeDataset(os.path.join(base_path,'test'), transform=transform)
